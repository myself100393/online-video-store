...
<%
	...
	Movie[] rentedMovieList = (Movie[]) request.getAttribute("rentedMovieList");
%>
...
<div class="rright">
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">User Information</a>
			</li>
			<li><a href="#tabs-2">Movie Search/Renting </a>
			</li>
			<li><a href="#tabs-3">Movie Return</a>
			</li>
			<li><a href="#tabs-4">Movie Listing/Renting</a>
			</li>
		</ul>
		<div id="tabs-1">
			<form id="userInfoForm" action="Account" method="post">
		...
		<div id="tabs-3">
			<form id="movieReturningForm" action="" method="post">
				<input id='btnP' type="hidden" name="buttonPressed" value="" /> <input
					type="hidden" name="FunctionCall" value="returnMovie" />
