 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {username, pwd});
  ...
  throw axisFaultException;
    ...
    public video.dto.Movie[] findMovies(java.lang.String name, java.lang.String banner, java.util.Calendar release, double rentalPrice, int category, boolean isAvailable) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {name, banner, release, new java.lang.Double(rentalPrice), new java.lang.Integer(category), new java.lang.Boolean(isAvailable)});
