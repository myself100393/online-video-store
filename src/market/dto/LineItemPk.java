...
/** 
 * This class represents the primary key of the LineItem table.
 */
public class LineItemPk implements Serializable
{
	 ...
	 * @param id
	 */
	public LineItemPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof LineItemPk)) {
			return false;
		}
		
		final LineItemPk _cast = (LineItemPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "market.dto.LineItemPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
