...
/** 
 * This class represents the primary key of the Account table.
 */
public class AccountPk implements Serializable
{
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof AccountPk)) {
			return false;
		}
		
		final AccountPk _cast = (AccountPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "market.dto.AccountPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
